...
# ========================
model_filename = "model/sensor_model_2017.11.19a.sav"
...
def get_measurements(name):
  ...
  parameters = [temperature, humidity, pressure, yaw, pitch, roll, mag_x, mag_y, mag_z, acc_x, acc_y, acc_z, gyro_x, gyro_y, gyro_z]
  print parameters
...
while True:
  ...
  schedule.enter(0.05,1,get_measurements,("read",))
  schedule.run() 
